...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_drawStaticObjects.setGeometry(QtCore.QRect(1380, 970, 111, 20))
        ...
        self.pushButton_StartRecord.setGeometry(QtCore.QRect(1510, 910, 131, 81))
        ...
        self.checkBox_drawGreenGrid.setGeometry(QtCore.QRect(1380, 940, 121, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_mainView.setText(_translate("MainWindow", "Loading..."))
        self.lbl_sideView_0.setToolTip(_translate("MainWindow", "Side View 1"))
        self.lbl_sideView_0.setText(_translate("MainWindow", "Loading..."))
        self.lbl_sideView_1.setToolTip(_translate("MainWindow", "Side View 2"))
        self.lbl_sideView_1.setText(_translate("MainWindow", "Loading..."))
        self.lbl_sideView_2.setToolTip(_translate("MainWindow", "Side View 3"))
        self.lbl_sideView_2.setText(_translate("MainWindow", "Loading..."))
        self.groupBox.setTitle(_translate("MainWindow", "YOLO Sensitivity"))
        self.checkBox_drawBoxes.setText(_translate("MainWindow", "Identified Vehicles"))
        self.checkBox_drawGrid.setText(_translate("MainWindow", "Grid"))
        self.checkBox_drawStaticObjects.setText(_translate("MainWindow", "Local Loads"))
        self.pushButton_StartRecord.setText(_translate("MainWindow", "Start Record"))
        self.checkBox_drawGreenGrid.setText(_translate("MainWindow", "Roads"))
